...
import { BigIntFmtModule } from '../core/ethers/big-int-format.module';
...
@NgModule({
  declarations: [StakeDaoComponent,StakeDaoPoolsComponent, StakeDaoPoolComponent, StakeDaoInOutFlowComponent],
  imports: [ CommonModule, SharedModule, StakeDAORoutingModule, BigIntFmtModule,NgxChartsModule,MatProgressSpinnerModule, MatDialogModule],
