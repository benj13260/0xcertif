...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<sdt-big-input-action></sdt-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<sdt-big-input-action [disabled]="true"></sdt-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<sdt-big-input-action fontSet="fas" fontIcon="fa-trash"></sdt-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<sdt-big-input-action label="delete"></sdt-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<sdt-big-input-action (action)="actionHandler()"></sdt-big-input-action>';
    fixture = createHostComponent(template);
